...
def d_flame_fitting(d_original, height_original, layer_thickness):
    ...
    d_flame[d_flame < 0] = 0.01
    return d_flame


def heat_flux_v(d_flame, height_original, z_height, layer_thickness):
    #z：观测点高度
    #d_flame:火焰直径，array
    #Height:火焰高度
    #L:火焰高度
...
def flame_rad_heat_pa(d_flame, height_original, rad_heat, layer_thickness):
    ...
    result=nsolve(func_qh_xa, X_a, 50) # 50 is the initial guess, this is required for nsolve function
    X_a=result
